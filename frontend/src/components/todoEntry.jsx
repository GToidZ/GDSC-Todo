        ...
        <div flex="~ row" items="center" justify="between"
            ...
            <div flex="~ row" gap="x-2" items="center">
                <input type="checkbox" checked={completed} onClick={toggle}
                    ...
                    w="4" h="4" border="~ solid gray-600 checked:goodo-red" rounded="sm"
                    bg="checked:goodo-red"
                    ring="hover:~ goodo-red offset-1"
                ></input>
                <span className={`${completed && "line-through"}`} text="gray-800">{label}</span>
            </div>
